...
file10 = URI.open("https://res.cloudinary.com/dk0declv9/image/upload/v1701226573/money-4068357_1280_dp7nop.png")
...
note.photos.attach(io: file2, filename: '2-anniversary-157248_1280_hpmnlq.png', content_type: 'image/png')
note.save!
